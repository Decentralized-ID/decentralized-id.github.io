...
**ϟ** I'm also working on **[/awesome-indy](https://github.com/infominer33/awesome-decentralized-id/blob/master/awesome-indy/)** as a place to focus more on the Sovrin/Indy protocol, governance, and ecosystem. I'm also spending some time on [/peacekeeper/blockchain-identity](https://github.com/peacekeeper/blockchain-identity/). I hope for these lists to compliment each-other.**ϟ**

For now, I'm becoming more familiar with all of this material, and how it fits together in the decentralized identity space. I expect to be actively engaged with this repository for the next month or so. It's starting to become really organized, in here. I look forward to seeing decentralized identity grow over the coming years.
