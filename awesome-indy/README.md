...
This page contains a growing collection of educational resources related to Evernym, the Sovrin Foundation, and Hyperledger Indy. It was born from [/awesome-decentralized-id](../README.md) and contains some of the same material. However, this list has a lot more specifically related to learning Hyperedger Indy. Its an index for training, developers, students, end users, investors, and enterprise to more easily navigate the self-sovereign digital identity landscape.
